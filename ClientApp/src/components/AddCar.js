...
export class AddCar extends Component {
    ...
    // these handle changes handle the input box text change. Could probably move into one versatile function
    ...
    //add car after inputting brand, name, color and type. 
    //inventory ID is randomly generated by .net before sent to API
    async addCar() {
